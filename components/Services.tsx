...
const services = [
  {
    ...
    desc: 'Built from scratch for your exact bottleneck. No templates, no compromises, no feature bloat.',
    detail: 'Architecture from first principles. Full source ownership. Your stack, your data, your model.',
  ...
  },
  {
    ...
    detail: 'Integrates with your existing tools. We map the process, build the engine, measure the margin recovery.',
  ...
  },
  {
    ...
    detail: 'Purpose-built for a single domain. Not a chatbot. Not a wrapper. A surgical instrument for one job.',
  ...
  },
  {
    ...
    detail: 'For operators who need a diagnosis before committing to a build. We find the three highest-leverage plays.',
