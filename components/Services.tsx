...
const services = [
  {
   ...
   desc: 'Stop guessing what to automate. In 60 minutes, we identify your single highest-ROI AI opportunity and hand you a written roadmap — or you don\'t pay.',
   detail: '$300. Includes AI Opportunity Audit ($2,500 value) + Prompt Engineering Playbook ($1,000 value). Money-back guarantee: if we find fewer than 3 opportunities, you don\'t pay.',
   href: '/services/consulting',
   bonus: 'Total package value: $3,800+. Your cost: $300.',
 },
  {
    num: '02',
    icon: 'automation' as const,
    name: 'AI Automation',
    desc: 'Your team reclaims 20+ hours a week. Not by working harder. By completely eliminating the busywork a machine should be doing instead.',
    detail: 'From $1,200. Includes 30-day post-launch support ($500 value) + Monthly Performance Dashboard ($500/mo value). We measure hours recovered monthly.',
    href: '/services/automation',
    bonus: 'If it doesn\'t pay for itself in 6 months, we fix it free. Total value: $1,700+ first month.',
  },
  {
    num: '03',
    icon: 'agents' as const,
    name: 'AI Agents',
    desc: 'Wake up to work already done. Your agent researches, writes, qualifies, and decides — so you only approve the outcomes, not every step.',
    detail: 'From $5,000. Includes 14-Day Prototype ($1,000 value): see it working with your data before we build the full system.',
    href: '/services/agents',
    bonus: 'You approve outcomes, not every step. Total value: $6,000+ first sprint. No license fees. Ever.',
  },
  {
    num: '04',
    icon: 'custom-ai' as const,
    name: 'Custom AI Systems',
    desc: 'One problem. One system. One fixed price. Built around your data, your workflow, your exact outcomes — and you own every line of code.',
