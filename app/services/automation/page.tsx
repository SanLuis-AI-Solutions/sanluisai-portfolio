  ...
  return (
    <>
      <PageHeader
        ...
        description="Your team loses 20–40 hours per week to work that follows predictable rules. We eliminate it — so your people focus on decisions, not data entry. Fixed price, 1–2 week delivery, you own the code."
      />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mb-16">
            ...
            <p className="sl-body-lg mb-4">
              Data entry, invoice matching, report generation, email triage, lead follow-up. Work that absolutely needs to happen — but absolutely does not need your most expensive people doing it. You know exactly which processes waste the most time. You just have not had the capacity to fix them.
            </p>
          ...
          <p className="sl-body-sm mb-8 max-w-2xl text-fg2">Every business has different bottlenecks. Here is how automation maps to common industry patterns — to give you a sense of what is possible.</p>
          ...
          <div className="bg-navy-900 border border-gold-600/30 rounded p-8 md:p-10 mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { step: '01', title: 'Map', desc: 'We identify the single process eating the most time. One hour, one bottleneck.' },
