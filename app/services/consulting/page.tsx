...
const sessionSteps = [
  ...
  },
  {
    ...
    items: [
      'Walk through your actual workflows — the bottlenecks, the kludges, the spreadsheets held together by hope',
