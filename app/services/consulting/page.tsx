      ...
      <main className="pt-16 bg-bgCanvas min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <p className="sl-body-lg max-w-prose mb-6">
            Strategic guidance for your AI journey. Not every problem needs a custom build. Sometimes you need a clear-eyed assessment of where AI can actually move the needle and where it would be a distraction.
          </p>
          <p className="sl-body-lg max-w-prose mb-6">
            We audit your operations, identify high-impact automation opportunities, and deliver a concrete roadmap. No jargon, no fluff, no overpromising. You get cost estimates, timeline projections, and a risk assessment for each initiative.
          </p>
