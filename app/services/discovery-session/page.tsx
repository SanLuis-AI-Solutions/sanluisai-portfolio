...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://sanluisai-portfolio.vercel.app/services/discovery-session',
      ...
      <section className="bg-bone-50 px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mb-16">
            ...
            <p className="sl-body-lg mb-4">
              The real problem is the phrase itself: &ldquo;we should do something with AI,&rdquo; with no clear answer to what, where, or how much. That uncertainty costs more than any software license. It delays decisions, burns budget on misplaced experiments, and leaves teams doing work that should have been automated months ago.
            </p>
            <p className="sl-body-lg mb-4">
