...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/generated/ind_healthcare_00001_.png', width: 1200, height: 630 }],
    locale: 'en_US',
    type: 'website',
  },
}
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection delay={0}>
            <div className="relative w-full h-48 md:h-72 rounded overflow-hidden mb-8 bg-navy-100">
              <Image src="/generated/ind_healthcare_00001_.png" alt="Modern AI-enhanced healthcare facility" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" priority />
            </div>
          </AnimatedSection>
