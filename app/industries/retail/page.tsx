      ...
      <section className="bg-bone-50 min-h-screen px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <AnimatedSection delay={0.1}>
            <p className="sl-body max-w-prose mb-4">SanLuis AI Solutions is a Houston-based AI automation company that builds working systems for small and mid-size retailers. Founded by Daniel San Luis, we reduce inventory waste, inconsistent customer service, and demand forecasting errors through fixed-price AI automation.</p>
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-gold-50 border border-gold-300 rounded p-6 mb-8">
              ...
              <p className="sl-body-sm mb-3">Founded by Daniel San Luis and based in Houston, Texas, SanLuis AI Solutions builds custom AI systems for retailers. A demand forecasting engine plugs into your POS and predicts stock requirements four weeks out. Customer service automation resolves 80% of inquiries without human escalation. Dynamic pricing adjusts margins in real time against demand, competitor data, and inventory position. Lead follow-up automation captures abandoned carts, repair inquiries, and loyalty lapses and drives them back to purchase.</p>
