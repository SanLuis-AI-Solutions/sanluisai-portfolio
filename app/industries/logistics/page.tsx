    ...
    <>
      ...
      <section className="bg-bone-50 min-h-screen px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 mb-8"><div className="bg-white border border-navy-900 rounded p-6"><div className="font-sans text-xs font-semibold uppercase tracking-wider text-gold-600 mb-2">Problem</div><div className="font-display text-lg text-navy-800">Route Optimization</div><div className="font-sans text-sm text-fg2 mt-2">Dynamic routing that adapts to traffic, weather, and demand — reducing fuel costs by 12-18%.</div></div><div className="bg-white border border-navy-900 rounded p-6"><div className="font-sans text-xs font-semibold uppercase tracking-wider text-gold-600 mb-2">Problem</div><div className="font-display text-lg text-navy-800">Warehouse Ops</div><div className="font-sans text-sm text-fg2 mt-2">AI-powered sorting, computer vision inventory tracking, and optimized pick paths.</div></div><div className="bg-white border border-navy-900 rounded p-6"><div className="font-sans text-xs font-semibold uppercase tracking-wider text-gold-600 mb-2">Problem</div><div className="font-display text-lg text-navy-800">Supply Chain Risk</div><div className="font-sans text-sm text-fg2 mt-2">Predictive models that flag disruptions 2 weeks in advance — not 2 hours.</div></div></div>
          <div className="mt-12">
