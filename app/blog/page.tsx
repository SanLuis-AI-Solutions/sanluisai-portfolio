...
export const metadata: Metadata = {
  ...
  description: 'Insights on AI, operations, and leverage for serious operators.',
}
    ...
    <>
      ...
      <main className="pt-16 bg-bgCanvas min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <p className="sl-body-lg max-w-prose mb-12">Insights on AI, operations, and leverage for operators who are serious about eliminating bottlenecks.</p>
          <div className="bg-white border border-navy-900 rounded p-8 text-center">
            <p className="sl-body text-fg3">First article coming soon.</p>
            <p className="sl-caption mt-2">We write when we have something to say. Not on a content calendar.</p>
          </div>
        </div>
      </main>
