      ...
      <article className="bg-bone-50 min-h-screen px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-navy max-w-none">
            ...
            <p>This is the most expensive mistake. A business has a broken workflow — too many approvals, unnecessary steps, redundant data entry — and decides to automate it instead of fixing it. The result is a fast, reliable version of a broken process.</p>
            <p><strong>The fix:</strong> Before automating anything, ask yourself: "If I redesigned this workflow from scratch, would it look like this?" If the answer is no, fix the process first, then automate. A Discovery Session is designed to catch this — we look for the simplest path to the outcome, not the most automated one.</p>
            ...
            <p><strong>The fix:</strong> Start with the problem, not the tool. What is the single most expensive manual task in your business right now? That's your automation target. The tool comes after — and it should be the simplest tool that solves the problem. A $1,200 workflow automation that fixes one thing is worth more than a $10,000 platform you haven't configured.</p>
            ...
            <p><strong>The fix:</strong> Assign one person — ideally the person whose job the automation is meant to help — as the project owner. Their job is to make sure the system actually gets used. When Susie's Jewelry Repair implemented their lead management system, the owner was the champion. That's why it worked.</p>

            <h2>Mistake #5: Measuring the Wrong Thing</h2>
            <p>Hours saved doesn't matter if those hours weren't used productively. A system that saves 10 hours of data entry per week is worthless if the team just shifts those 10 hours to other low-value work. The metric that matters is: what does the business achieve now that it couldn't before?</p>
            ...
            <p>Every mistake above shares a root cause: treating automation as a technology project instead of a business project. The technology is the easy part. The hard part is picking the right problem, setting the right scope, and making sure the solution actually gets used.</p>
            <p>That's why our Discovery Session starts with a business question — "what is the single most expensive problem in your business?" — not a technology question. If we can answer that clearly, the right automation path becomes obvious.</p>
