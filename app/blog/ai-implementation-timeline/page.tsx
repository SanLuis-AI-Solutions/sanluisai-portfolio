...
export default function Page() {
  return (
    <>
      ...
      <PageHeader eyebrow="Process" title="From $300 Discovery to Live AI System: What 14 Days Actually Look Like" description="No black boxes. No six-month pilot programs. Just a clear timeline with real milestones." />
      ...
      <article className="bg-bone-50 min-h-screen px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-navy max-w-none">
            ...
            <p>Sixty minutes. We map your workflow from trigger to outcome. We find the bottleneck — the single step that costs the most time, generates the most errors, or loses the most deals.</p>
